    ...
    >
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <FundsTable
          ...
          emptyText="صندوق جسورانه یافت نشد."
          rowKey={(f) => f.regNo}
        />
      </motion.div>
    </FundsPageLayout>
