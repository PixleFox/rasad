      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <motion.div {...fade(0)} className="text-center mb-20">
          ...
          <h1 className="text-4xl sm:text-5xl text-white mb-5" style={{ fontWeight: 900 }}>
            سایت <span className="text-neon-cyan">رصد</span> چیست؟
          </h1>
          <p className="text-text-muted text-base leading-relaxed max-w-2xl mx-auto" style={{ fontWeight: 600 }}>
            رصد یک سایت فارسی برای تحلیل، رتبه‌بندی و مقایسه صندوق‌های سرمایه‌گذاری ایران است؛
            ابزاری برای اینکه سرمایه‌گذار، مدیر صندوق و تیم بازاریابی بتوانند داده‌های صندوق‌ها را سریع‌تر و شفاف‌تر ببینند.
          </p>
        </motion.div>
        ...
        <motion.section {...fade(0.1)} className="mb-20">
          <div className="rounded-2xl border border-neon-cyan/10 bg-surface/30 backdrop-blur-sm p-8 sm:p-10">
            ...
            <div className="space-y-5 text-text-muted leading-relaxed text-sm" style={{ fontWeight: 600 }}>
              <p>
                سایت رصد در نشانی <span className="text-text-primary" dir="ltr">ra100.ir</span> در دسترس است و روی داده‌های صندوق‌های سرمایه‌گذاری ایران تمرکز دارد. اگر کسی بپرسد «سایت رصد چیست؟»، پاسخ کوتاه این است: رصد یک پلتفرم داده‌محور برای مقایسه صندوق‌ها، بررسی بازدهی، ریسک، دارایی تحت مدیریت و جریان پول صندوق‌هاست.
              </p>
              <p>
              ...
              <p>
                رصد با هدف پر کردن این خلأ ساخته شد. نه فقط یک جدول ساده از بازدهی‌ها، بلکه یک <span className="text-text-primary">پلتفرم هوشمند</span> که داده‌های خام فیپیران و بازار را به بینش‌های عملی تبدیل می‌کند: از شاخص ترکیبی رصد تا تحلیل مارکتینگ صندوق‌ها.
              </p>
              <p>
